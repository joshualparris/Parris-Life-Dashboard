...
export const apps: CatalogItem[] = [
  ...
  },
  {
    ...
    category: "Games",
    status: "ok",
    tags: ["game", "office", "horror", "rpg", "browser", "playable"],
    primaryUrl: "/games/nexus-descent/index.html",
    urls: [{ label: "Play (Local)", url: "/games/nexus-descent/index.html" }],
    notes: "Long-form static browser RPG built around a corporate site that unfolds into factions, companions, codex entries, save slots, combat, and multiple endings.",
    nextAction: "Expand epilogue variants or add audio if you want a second content pass.",
    lastTouched: "2026-03",
  },
  {
    id: "orgscape",
